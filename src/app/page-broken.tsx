...
// Import new stunning components (temporarily commented for debugging)
              ...
              >
                {[
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <Card className="bg-background/50 backdrop-blur border border-white/20 hover:bg-background/70 transition-all duration-300 transform hover:scale-105">
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-950/20 dark:to-orange-950/20 p-3 rounded-lg">
                ...
                <p className="text-xs text-muted-foreground">"Focus on useState optimization for 2x faster learning"</p>
              </div>
            </div>
